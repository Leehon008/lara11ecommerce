                        ...
                        <div class="search-field multi-select accordion-body px-0 pb-0">
                            ...
                            <ul class="multi-select__list list-unstyled">
                                ...
                                <li class="search-suggestion__item multi-select__item text-primary js-search-select js-multi-select">
                                    ...
                                    {{-- <span class="text-secondary">{{ $brand->id }}</span> --}}
                                </li>
                                @endforeach
                            </ul>
                        </div>
        ...
        <div class="slideshow-pagination d-flex align-items-center position-absolute bottom-0 mb-4 pb-xl-2"></div>
            ...
            <div class="d-flex justify-content-between mb-4 pb-md-2">
                <div class="breadcrumb mb-0 d-none d-md-block flex-grow-1">
                    ...
                    <label class="text-uppercase fw-medium">The Shop</label>
                </div>
                ...
                <div class="shop-acs d-flex align-items-center justify-content-between justify-content-md-end flex-grow-1">
                    ...
                    <div class="col-size align-items-center order-1 d-none d-lg-flex">
                        ...
                        <button class="btn-link fw-medium me-2 js-cols-size" data-target="products-grid" data-cols="1">1</button>
                ...
                <div class="product-card-wrapper">
                    <div class="product-card mb-3 mb-md-4 mb-xxl-5">
                        <div class="pc__img-wrapper">
                            ...
                            <a href="{{ route('cart.index') }}" class="pc__atc btn anim_appear-bottom btn position-absolute border-0 text-uppercase fw-medium btn btn-warning mb-3">Go
                                to Cart</a>
                            @else
                        ...
                        <div class="pc__info position-relative">
                            ...
                            <h6 class="pc__title"><a href="{{ route('shop.product.details', ['product_slug' => $product->slug]) }}">{{ $product->name }}</a>
                            </h6>
