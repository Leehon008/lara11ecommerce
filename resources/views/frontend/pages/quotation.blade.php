                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="form-group">
                                ...
                                <select id="delivery-location" name="delivery-location" class="form-control select2"
                                    required>
                                    ...
                                    @foreach ($categories as $category)
                                        <div class="col-md-4">
                                            <div class="form-check mb-3">
                                                <input class="form-check-input form-check-input_fill service-checkbox"
                                                    type="checkbox" name="services[]" value="{{ $category->id }}"
