...
@section('title', 'Create Best For Creative Account')
@section('content')
<main class="pt-90">
        ...
        <div class="tab-pane fade show active" id="tab-item-register" role="tabpanel" aria-labelledby="register-tab">
          <div class="register-form">
            <form method="POST" action="#" name="register-form" class="needs-validation" novalidate="">
              ...
              <div class="form-floating mb-3">
                <input class="form-control form-control_gray" name="surname" value="" required="" autocomplete="surname"
                  autofocus="" />
              ...
              <div class="form-floating mb-3">
                <input id="mobile" type="text" class="form-control form-control_gray" name="mobile" value="" required=""
                  autocomplete="mobile" />
              ...
              <div class="customer-option mt-4 text-center">
                ...
                <a href="{{ url('login') }}" class="btn-text js-show-register">Login to your Account</a>
              </div>
            </form>
          </div>
        </div>
